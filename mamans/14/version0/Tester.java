public class Tester {
  ...
  public static void main(String[] args) {
    ...
    CityNode n2 = new CityNode(c2,n1);
    CityNode n3 = new CityNode(c3,n2);
    CityNode n4 = new CityNode(n3);
n2.setNext(n4);
n3.setCity(c4);
     System.out.println(n3.getNext().getCity());
    ...
    System.out.println(
     ...
     c1 = new City("Jerusalem", 1, 2, 3, 4, 5, 6, 7, 8, 9);
    CityNode cn1 = new CityNode(c1);
     c2 = new City("Tel-Aviv", 11, 12, 13, 14, 15, 16, 17, 18, 19);
